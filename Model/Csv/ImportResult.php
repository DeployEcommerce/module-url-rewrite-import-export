...
class ImportResult
{
    ...
    /**
     * Rows that lost the autogenerated slot for their entity and were turned into
     * 301 redirects to the winning path.
     */
    public function addDemoted(int $count): void
    {
        $this->demoted += $count;
    }
    ...
    public function getDemoted(): int
    {
        return $this->demoted;
    }
